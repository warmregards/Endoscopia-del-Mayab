    ...
    <div className="pb-24 md:pb-0">
      ...
      <section className="bg-background">
        <div className="container-narrow section-padding">
          ...
          {/* SECTION 3.5 — Trust video placeholder.
              Gray 9:16 block until the self-hosted vertical clip is produced.
              When ready, swap this block for <LpVideo src=… poster=… /> (the
              component is built and ready in components/LpVideo.tsx). Detailed
              video spec to come. */}
          <figure className="mx-auto mt-10 max-w-[320px]">
            <div className="flex aspect-[9/16] items-center justify-center rounded-2xl border border-border bg-muted">
            ...
            <figcaption className="mt-4 text-center text-sm text-muted-foreground">
              El Dr. Omar Quiroz — Endoscopista Gastrointestinal y Cirujano
              General.
            </figcaption>
          </figure>
        </div>
